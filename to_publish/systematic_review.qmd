...
2.  applies a QAQC script to fix typos and errors
3.  applies a script to create new columns for phytoplankton and cyanobacterial drivers, responses, and measured variables
4.  Creates all of the manuscript figures
5.  Creates all of the SI figures
...
source(here::here("Systematic/Scripts/qaqc_data_sysreview.R"))

results <- qaqc_data_sysreview("Systematic/Combined_08Oct.csv")

data <- results$data
excluded_papers <- results$excluded_papers

write.csv(data, file = here("Systematic/Data/qaqc_sysreviewdata.csv"))
...
result <- data %>%
  ...
  # keep lakes with water level decrease AND biological decrease
# filter(
#   (!is.na(decrease_phyto_response) | !is.na(decrease_cyano_response)) &
#   (decrease_phyto_response == "Decrease in phytoplankton" |
#    decrease_cyano_response == "Decrease in cyanobacteria")
# ) |> 
  filter(
...
source(here::here("Systematic/Scripts/extract_drivers.R"))
...
source(here::here("Systematic/Scripts/proportion_WL.R"))
...
This chunk will generate a logistic regression plots for both phytoplankton and cyanobacteria.
...
ggsave(paste0(here(),"/Systematic/Plots/logreg.jpg"), plot = all, height = 4, width = 8, units = "in")
...
ggsave(paste0(here(),"/Systematic/Plots/maxsa.jpg"), plot = maxsa, height = 3, width = 6.5, units = "in")

ggsave(paste0(here(),"/Systematic/Plots/maxcombined.jpg"), plot = maxsadepth, height = 3, width = 4, units = "in")
```
